...
static inline sem_id   sem_create( unsigned limit ) { return (sem_id) OSCall(SEM_create, limit); }

// reset obiektu 'sem'
// wszystkie procesy oczekuj¹ce zostaj¹ wybudzone
// zostaje do nich wys³any komunikat E_STOPPED
              void     SEM_kill( sem_id sem );
static inline void     sem_kill( sem_id sem ) { OSCall(SEM_kill, sem); }
...
static inline unsigned sem_waitUntil( sem_id sem, unsigned time ) { return OSCall(SEM_waitUntil, sem, time); }
...
static inline unsigned sem_waitFor( sem_id sem, unsigned delay ) { return OSCall(SEM_waitFor, sem, delay); }
...
static inline unsigned sem_sendUntil( sem_id sem, unsigned time ) { return OSCall(SEM_sendUntil, sem, time); }
...
static inline unsigned sem_sendFor( sem_id sem, unsigned delay ) { return OSCall(SEM_sendFor, sem, delay); }
